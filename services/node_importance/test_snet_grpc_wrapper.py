...
class TestNodeImportance(unittest.TestCase):
    ...
    # 	self.assertEqual(result.message,'success')
    # 	self.assertEqual(
    # 		("'2': 0.8" in result.output and
    # 		 "'1': 0.5714285714285714" in result.output and
    # 		 "'3': 1.2" in result.output and
    # 		 "'4': 0.8571428571428571" in result.output and
    # 		 "'5': 0.75" in result.output and
    # 		 "'6': 0.75" in result.output and
    # 		 "'7': 0.75" in result.output and
    # 		 "'8': 0.75" in result.output
    # 		 ), True)
    #
    # 	# Graph With No Nodes
    ...
    #
    # 	# Graph With No Nodes
    # 	result = self.client.find_hub_matrix(self.stub,self.graph_01)
    # 	self.assertEqual(result[0],'False')
    # 	self.assertEqual(result[1],"'nodes'")
    # 	self.assertEqual(result[2],{})
    #
    # 	# Graph With No edges
    # 	result = self.client.find_hub_matrix(self.stub,self.graph_02)
    # 	self.assertEqual(result[0],'False')
    # 	self.assertEqual(result[1],"'edges'")
    # 	self.assertEqual(result[2],{})
    #
