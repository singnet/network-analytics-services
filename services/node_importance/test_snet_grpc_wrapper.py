...
class TestNodeImportance(unittest.TestCase):
	...
	def test_find_closeness_centrality(self):
		...
		self.assertEqual(result.messgae,'success')
		# try:
		# 	self.assertEqual(result.output,"{'1': 0.5714285714285714, '2': 0.8, '6': 0.75, '4': 0.8571428571428571, '8': 0.75, '7': 0.75, '3': 1.2, '5': 0.75}}")
		# except Exception as e:
		# 	self.assertEqual(result.output,"{'2': 0.8, '1': 0.5714285714285714, '8': 0.75, '7': 0.75, '4': 0.8571428571428571, '3': 1.2, '6': 0.75, '5': 0.75}}")
